...
<div class='row'>
	<div class='col-lg-6'>
    	<h3 style='margin-bottom:0px; margin-top:0px;'><i class='fa fa-bookmark'></i>&nbsp; เพิ่ม/แก้ไข ประเภทสินค้า</h3>
    </div>
    <div class="col-lg-6">
    	<p class='pull-right'>
...
<div class='row'>
    ...
    <thead>
    	<tr style='font-size:12px;'>
            ...
            <th style='width:15%;'>ชื่อประเภท</th>
	...
	<?php if($data != false) : ?>
        ...
        <?php foreach($data as $rs): ?>
        		<tr style="font-size:12px;">
                    ...
                    <td style="vertical-align:middle;"><?php echo $rs->type_name; ?></td>
                    ...
                    <td align="right" style="vertical-align:middle;">
                    	<a href="<?php echo base_url(); ?>admin/type/edit/<?php echo $rs->id_type; ?>" >
                        	<button type="button" class="btn btn-warning" <?php echo $access['edit']; ?>><i class="fa fa-pencil"></i></button></a>
                        <a href="<?php echo base_url(); ?>admin/type/delete/<?php echo $rs->id_type; ?>">
                            <button type="button" class="btn btn-danger" onclick="return confirm('คุณแน่ใจว่าต้องการลบ <?php echo $rs->type_name; ?> ? โปรดจำไว้ว่าการกระทำนี้ไม่สามารถกู้คืนได้');" <?php echo $access['delete']; ?>>
