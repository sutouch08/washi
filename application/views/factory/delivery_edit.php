    ...
    <div class="col-lg-6">
    	<p class='pull-right'>
        	<a href="<?php echo base_url(); ?>factory/delivery">
             ...
             <a href="<?php echo base_url(); ?>factory/delivery/edit_detail/<?php echo $id_delivery; ?>">
        		<button class='btn btn-primary'><i class='fa fa-mail-forward'></i>&nbsp; ข้าม</button>
             </a>
...
<div class='row'>
<?php echo form_open(base_url()."factory/delivery/update_data"); ?>
<?php if($data != false) : ?>
