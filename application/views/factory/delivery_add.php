...
<div class='row'>
<?php echo form_open(base_url()."factory/delivery/insert_data"); ?>
...
<div class='col-lg-3'>
	<div class="input-group">
        ...
        <input type="text" class="form-control" value="<?php echo newDeliveryNumber(); ?>" disabled  />
    </div>
</div>    
<div class='col-lg-3'>
	<div class="input-group">
    	<span class="input-group-addon">ปลายทาง</span>
        <select name="id_target" id="id_target" class="form-control" ><?php echo selectShop(); ?></select>
    </div>
</div> 
<div class='col-lg-3'>
	<div class="input-group">
    	<span class="input-group-addon">ทะเบียนรถ</span>
        <select name="id_car" id="id_car" class="form-control" ><?php echo selectCar(); ?></select>
    </div>
</div> 
<div class='col-lg-3'>
	<div class="input-group">
    	<span class="input-group-addon">พนักงานขับ</span>
        <select name="id_driver" id="id_driver" class="form-control" ><?php echo selectDriver(); ?></select>
    </div>
</div> 
