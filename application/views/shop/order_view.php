...
<div class='row'>
	<div class='col-lg-6'>
    	<h3 style='margin-bottom:0px; margin-top:0px;'><i class='fa fa-file-o'></i>&nbsp; เพิ่ม/แก้ไข ออเดอร์ </h3>
    </div>
    <div class="col-lg-6">
    	<p class='pull-right'>
        	<a href="<?php echo base_url(); ?>shop/order/delete">
        		<button class='btn btn-danger'<?php echo $access['delete']; ?>><i class='fa fa-trash'></i>&nbsp; ลบออเดอร์</button>
             </a>
        	<a href="<?php echo base_url(); ?>shop/order/add">
