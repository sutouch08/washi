...
class Customer extends CI_Controller
{
	...
	public $home;
	public $view 		= "shop/customer_view";
	public $add 			= "shop/customer_add";
	public $edit 			= "shop/customer_edit";
	
	public function __construct()
	{
		parent::__construct();
		$this->home = base_url()."shop/customer";
	...
	public function detail($id)
	{
		...
		$data['view'] 		= "shop/customer_detail";
