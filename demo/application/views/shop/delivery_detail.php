...
<thead>
<tr><th style="width:15%;">เลขที่อ้างอิง</th><th style="width:35%">ลูกค้า</th><th style="width:15%; text-align:right">จำนวน</th><th>&nbsp;</th></tr>
</thead>
<?php if($order != false) : ?>
<?php foreach($order as $or) : ?>
<tr>
	<td><?php echo getOrderNumber($or->id_order); ?></td><td><?php echo getCustomerName(getCustomerId($or->id_order)); ?></td><td align="right"><?php echo $or->qty; ?></td><td>&nbsp;</td>
</tr>     
<?php endforeach; ?>
<?php endif; ?>    
