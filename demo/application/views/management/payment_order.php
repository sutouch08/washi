...
<div class='row'>
	<div class='col-lg-6'>
    	<h3 style='margin-bottom:0px; margin-top:0px;'><i class='fa fa-dashboard'></i>&nbsp; รายงานการรับเงิน (เฉพาะออเดอร์)</h3>
    </div>
     <div class='col-lg-6'>
...
function get_report(){
	...
	if(shop == 0){
		...
		window.location.href="<?php echo $this->home."/payment_order/rank/"; ?>"+shop+"/"+from+"/"+to;
	}
}
...
function payment_report(i){
	...
	if(shop == 0){
		...
		if(i =="x"){
			window.location.href="<?php echo $this->home."/payment_order/this_month/"; ?>"+shop;
		}else{
			window.location.href="<?php echo $this->home."/payment_order/day/"; ?>"+shop+"/"+i;
		}
	}
}
