...
<div class='row'>
	<div class='col-lg-6'>
    	<h3 style='margin-bottom:0px; margin-top:0px;'><i class='fa fa-book'></i>&nbsp; แก้ไข ตารางเวลา</h3>
    </div>
    <div class="col-lg-6">
    	<p class='pull-right'>
...
<?php 
	...
	if($data != false){
		foreach($data as $rs){
			$id = $rs->id; $name = $rs->name; $start = $rs->start; $end = $rs->end;
		}
	}
	?>
<form id="set_time_form" action="<?php echo base_url(); ?>admin/set_time/update_table/<?php echo $id; ?>" method="post" >
<div class='row'>
<div class="col-lg-5" style="text-align:right">ชื่อช่วง</div>
<div class="col-lg-2"><input type="text" name="name" id="name" class="form-control" value="<?php echo $name; ?>" placeholder="ชื่อสำหรับเรียกช่วงเวลา" required="required" autofocus="autofocus" /></div>
<div class="col-lg-5"><span style="color:red">*</span></div>
<div class="col-lg-12">&nbsp </div>

<div class="col-lg-5" style="text-align:right">ตั้งแต่</div>
<div class="col-lg-2"><input type="text" name="start" id="start" class="form-control" value="<?php echo $start; ?>" placeholder="กำหนดเวลาเริ่มต้น" required="required" /></div>
<div class="col-lg-5"><span style="color:red">*</span></div>
<div class="col-lg-12">&nbsp </div>

<div class="col-lg-5" style="text-align:right">ถึง</div>
<div class="col-lg-2"><input type="text" name="end" id="end" class="form-control" value="<?php echo $end; ?>" placeholder="กำหนดเวลาสิ้นสุด" required /></div>
<div class="col-lg-5"><span style="color:red">*</span></div>
<div class="col-lg-12">&nbsp </div>
