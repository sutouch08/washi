...
<div class='row'>
	<div class='col-lg-6'>
    	<h3 style='margin-bottom:0px; margin-top:0px;'><i class='fa fa-bookmark'></i>&nbsp; เพิ่ม ประเภท</h3>
    </div>
    <div class="col-lg-6">
    	<p class='pull-right'>
...
<div class='row'>
<?php echo form_open(base_url()."admin/type/insert_data"); ?>
<div class='col-lg-4' style="text-align:right">ชื่อประเภท</div><input type="hidden" id="valid_code" value="0"/>
<div class="col-lg-4"><input type="text" class="form-control" name="type_name" id="type_name" required="required" autocomplete="off"/></div><div class="col-lg-4"><span style="color:red";>*</span></div>
...
<script>
	$("#type_name").keyup(function(e){
		var code = $(this).val();
		$.ajax({
			url:"<?php echo base_url()."admin/type/valid_code/"; ?>"+code,
			cache:false,
