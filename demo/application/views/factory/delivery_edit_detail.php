...
<?php echo form_open(base_url()."factory/delivery/confirm_edit/".$rs->id_delivery, array("id"=>"delivery_form")); ?>
...
function cancle(id_order){
	...
	window.location.href="<?php echo base_url(); ?>factory/delivery/delete_detail/"+id_order+"/"+id_delivery+"/edit";
}
