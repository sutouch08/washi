...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="font-size:10px;">
                   ...
                   <tr height="20px">
                    ...
                    <tr height="20px">
                        <td colspan="2" align="right">Balance payment</td><td colspan="2" align="right"><?php echo number($balance,1); ?></td>
                    </tr>
                    <tr height="20px">
   ...
   <center>  THANK YOU</center>
      <hr>  
      <div class="hidden-print" style="margin-bottom:10px;">
      <a href="<?php echo base_url();?>shop/order/detail/<?php echo $id_order; ?>">
		<button class="btn btn-success btn-xs btn-block" type="button" id="btn_back"><i class="fa fa-reply"></i>&nbsp; กลับ </button>
      </a>
</div>
</div>
<script>
...
$("#btn_back").click(function(){
	window.location.href = "<?php echo base_url()."shop/order/detail/".$id_order; ?>";
});
