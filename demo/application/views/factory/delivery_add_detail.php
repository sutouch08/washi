...
<div class='row'>
	<div class='col-lg-6'>
    	<h3 style='margin-bottom:0px; margin-top:0px;'><i class='fa fa-truck'></i>&nbsp; ส่งออเดอร์</h3>
    </div>
    <div class="col-lg-6">
    	<p class='pull-right'>
...
<?php echo form_open(base_url()."factory/delivery/confirm/".$rs->id_delivery, array("id"=>"delivery_form")); ?>
...
<tr id="row<?php echo $or->id_order; ?>">
    ...
    <td align="right"><?php echo get_finished_qty($or->id_order); ?></td><td align="right"><?php echo get_finished_amount($or->id_order); ?></td>
    <td align="right"><?php echo get_finished_weight($or->id_order); ?> กก.</td><td align="center"><?php echo getUrgent($or->id_urgent); ?></td>
...
<tr id="row<?php echo $or->id_order; ?>">
    ...
    <td align="right"><?php echo get_finished_qty($or->id_order); ?></td><td align="right"><?php echo get_finished_amount($or->id_order); ?></td>
    <td align="right"><?php echo get_finished_weight($or->id_order); ?> กก.</td><td align="center"><?php echo getUrgent($or->id_urgent); ?></td>
    <td align="right"><button type="button" class="btn btn-danger" id="btn_<?php echo $or->id_order; ?>" onclick="cancle(<?php echo $or->id_order; ?>);"><i class="fa fa-trash"></i>&nbsp; ยกเลิก</button></td>
</tr>     
<?php endforeach; ?>
<?php endif; ?>    
