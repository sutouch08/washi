...
<?php
	...
	while($i<$row)
	{
		...
		$status_id = $rs_s['status_id'];
				...
				<a style='color:red;' href='delete.php?delivery_id=".$delivery_id."&status_id=$status_id' ><button type=\"button\" name=\"button\" id=\"button\"  class=\"btn btn-default\" onclick=\"return confirm('ต้องการลบ  หรือไม่');\" >Delete</button></a></td></tr>
				";
		 $i++;
		 $no++;
		}
