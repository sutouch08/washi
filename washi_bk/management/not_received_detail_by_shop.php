				...
				<div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4>รายละเอียดงานค้างส่ง &nbsp;ร้าน&nbsp;&nbsp;<?  if(isset($shop_id)){ echo $shop_name;} ?>&nbsp;&nbsp; &nbsp; <?  if(isset($shop_id)){ echo showRang($view,$from_date,$to_date);} ?></h4>
                        </div>
						...
						<table class="table table-bordered table-hover">
							...
							<? 
								...
								$from_date = $_GET['from'];
								$to_date = $_GET['to'];
								$query = getNotReceivedDetailByShop($shop_id, $view, $from_date, $to_date);
								$row = dbNumRows($query);
								$i = 0;
								$n = 1;
								while($i < $row){
