				...
				<div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4>รายละเอียดการขาย ร้าน&nbsp;&nbsp; &nbsp; <?  if(isset($shop_id)){ echo $shop_name;} ?>&nbsp;&nbsp; &nbsp; <?  if(isset($shop_id)){ echo showRang($view,$from_date,$to_date);} ?></h4>
                        </div>
						...
						<table class="table table-bordered table-hover">
							...
							<? 
								...
								$from_date = $_GET['from'];
								$to_date = $_GET['to'];
								$query = getDetailByShop($shop_id, $view, $from_date, $to_date);
								$row = dbNumRows($query);
								$i = 0;
								$n = 1;
								while($i < $row){
                        ...
                        <div class="panel-footer"><a href="<? echo"index.php?content=$page&shop_id=$shop_id&view=$view&from_date=$from_date&to_date=$to_date";?>"><button type="button" class="btn btn-primary">Go Back</button></a></div>
                    </div>
                </div>
