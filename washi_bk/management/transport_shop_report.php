                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        ...
                        <div class="panel-body">
						 ...
						 if(isset($_POST['from_date'])){
							 $shop_id = $_POST['shop_id'];
						  $sql = "SELECT * FROM tbl_order LEFT JOIN tbl_urgent ON tbl_order.urgent_id = tbl_urgent.urgent_id where shop_id = '$shop_id' and status = '2' ORDER BY  `tbl_urgent`.`urgent_id` DESC ";
						  $result = dbQuery($sql);
...
<br />
 <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
						 ...
						 if(isset($_POST['from_date'])){
						 $shop_id = $_POST['shop_id'];
						  $sql = "SELECT * FROM tbl_delivery_detail LEFT JOIN tbl_delivery ON tbl_delivery_detail.delivery_id = tbl_delivery.delivery_id LEFT JOIN tbl_order ON tbl_delivery_detail.order_id = tbl_order.order_id where delivery_date LIKE '%$from_date%' and tbl_delivery.shop_id = '$shop_id'";
						  $result = dbQuery($sql);
							$row = dbNumRows($result);
							$i=0;
							$n=1;
