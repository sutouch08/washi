	...
	$credit_unit = $rs_m['credit_unit'];
				...
				?>                       
                  ...
                  <?
					...
					?>
                     <tr>
                        <td colspan="3" style="border-bottom:none; border-top:none;"  >( <? echo Currency::bahtThai($sum_price);?> )</td><td width="15%"><?=$sum_qty;?></td><td width="15%"><?=$sum_amount;?></td>
                    </tr>
                     <tr>
