    ...
    <div class="navbar navbar-default navbar-static-top" role="navigation">
      <div class="container">
        ...
        <ul class="nav  navbar-nav">
                    <? if($pageTitle=='Dash board'){echo"<li></li>";}else{echo"<li><a href='index.php'><img src='../images/UI/back.png' ></a></li>";}?>
                    <? //if($pageTitle=='Receive Delivery'){ echo "<li class='active'><a href='#'>Receive Delivery</a></li>";} else { echo "<li ><a href='index.php?content=Receive'>Receive Delivery</a></li>";}?>
                    <? //if($pageTitle=='NEW'){ echo "<li class='active'><a href='#'>NEW</a></li>";} else { echo "<li ><a href='index.php?content=NEW'>NEW</a></li>";}?>
                    <? //if($pageTitle=='Process'){ echo "<li class='active'><a href='#'>Process</a></li>";} else { echo "<li ><a href='index.php?content=Process'>Process</a></li>";}?>
                   <? //if($pageTitle=='finish'){ echo "<li class='active'><a href='#'>finish</a></li>";} else { echo "<li ><a href='index.php?content=finish'>FINISH</a></li>";}?>
                </ul>
