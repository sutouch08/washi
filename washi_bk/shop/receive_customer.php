 ...
 <table class="table table-hover">
    <thead>
    <tr ><td width="5%"><h4>#</h4></td><td width="20%"><h4>Order No.</h4></td><td width="5%"><h4>Name</h4></td><td width="5%"><h4>Amount</h4></td><td width="15%"><h4>Order Date</h4></td>
    <td width="20%"><h4>Due Date</h4></td><td width="10%"><h4>Condition</h4></td><td width="15%"><h4>Status</h4></td><td width="10%"><h4></h4></td></tr></thead>
   
    
      <?php
  
		  $sql = "SELECT * FROM tbl_order LEFT JOIN tbl_customer ON tbl_order.customer_id = tbl_customer.customer_id  LEFT JOIN tbl_urgent ON tbl_order.urgent_id = tbl_urgent.urgent_id LEFT JOIN tbl_status ON tbl_order.status = tbl_status.status_id WHERE status = '16' and tbl_order.shop_id = ".$shop_id." ORDER BY  tbl_order.order_date_time ASC";
