...
<table class="table table-hover">
	...
	<?php 
												    ...
												    <div class='modal-body' style='width:900px;'>";?><script>
															...
															function validate<? echo $n; ?>()
															{
																...
																if(checked<? echo $n; ?>==1){
																	...
																	alert('Please fill out Product name fild123.');
		...
		<td width='10%' align='left'><input type='text' class='form-control' name='weight' id='weight' placeholder='น้ำหนัก' value='$weight' /></td>
						...
						<tr>
						<td width='5%' align='right'>type : </td><td width='23%'>";?><select class='form-control' name='type_id'><? typeDropdown();?></select><? echo "</td>
						<td colspan='5'></td>
