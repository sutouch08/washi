	...
	$credit_unit = $rs_m['credit_unit'];
				...
				?>                       
                  ...
                  <?
					...
					?>
                     <tr>
                        <td colspan="3" style="border-bottom:none; border-top:none;"  >( <? echo bahtThai($sum_discount1);?> )</td><td width="15%"><?=$sum_qty;?></td><td width="15%"><?=$sum_amount;?></td>
                    </tr>
                     <tr>
...
<a href="index.php?content=bill&order_id=<?=$order_id;?>">
    <button type="button" class="btn btn-default btn-lg">ใบเสร็จ</button></a>
